...
*Include support scenarios only active when feature flag is enabled*
...
---
*Modification spec created using `/speckit.modify` workflow - See .specify/extensions/workflows/modify/*
