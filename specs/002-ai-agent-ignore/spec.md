...
- Q: Configuration storage format: Where should AI agent ignore patterns be primarily stored? → A: VS Code workspace settings (`.vscode/settings.json`) PLUS detect and respect other AI agent configuration files (`.claude/settings.json`, Copilot settings, and similar)
